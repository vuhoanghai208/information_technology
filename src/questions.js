...
// ========================================================================
  ...
  
  {
    subject: 'html',
    type: 'match',
    q: "Ghép thẻ HTML với chức năng tương ứng:",
    pairs: [
      { id: 1, left: "<a>", right: "Tạo liên kết (Hyperlink)" },
      { id: 2, left: "<ul>", right: "Danh sách không thứ tự (Dấu chấm tròn)" },
      { id: 3, left: "<table>", right: "Tạo bảng hiển thị dữ liệu" },
      { id: 4, left: "<input>", right: "Ô để người dùng nhập liệu" }
    ],
    e: "Thẻ <a> dùng href để dẫn link. <ul> (Unordered List) tạo list chấm tròn. <table> chứa tr/td. <input> dùng trong form."
  },
  {
    subject: 'html',
    type: 'match',
    q: "Ghép thuộc tính CSS với ý nghĩa:",
    pairs: [
      { id: 1, left: "display: flex", right: "Dàn trang linh hoạt (Hàng/Cột)" },
      { id: 2, left: "padding", right: "Khoảng cách từ nội dung đến viền" },
      { id: 3, left: "margin", right: "Khoảng cách giữa các phần tử với nhau" },
      { id: 4, left: "color", right: "Màu sắc của chữ (Text)" }
    ],
    e: "Padding là đệm bên trong (Inside), Margin là lề bên ngoài (Outside). Display: flex là công cụ layout mạnh nhất."
  },
  {
    subject: 'html',
    type: 'match',
    q: "Ghép các loại đường dẫn (Path):",
    pairs: [
      { id: 1, left: "Tuyệt đối (Absolute)", right: "https://google.com/image.png" },
      { id: 2, left: "Tương đối (Relative)", right: "./images/logo.png" },
      { id: 3, left: "Root Relative", right: "/assets/style.css" },
      { id: 4, left: "Anchor Link", right: "#section-1" }
    ],
    e: "Đường dẫn tuyệt đối chứa đầy đủ domain. Tương đối dựa trên vị trí file hiện tại."
  },
  ...
  // --- CHỦ ĐỀ: MẠNG MÁY TÍNH ---
  {
    subject: 'network',
    type: 'match',
    q: "Ghép giao thức mạng với đặc điểm cốt lõi:",
    pairs: [
      { id: 1, left: "TCP", right: "Chậm, tin cậy, có sửa lỗi (Gửi Email, Web)" },
      { id: 2, left: "UDP", right: "Nhanh, chấp nhận mất dữ liệu (Livestream)" },
      { id: 3, left: "DNS", right: "Danh bạ Internet (Dịch tên miền sang IP)" },
      { id: 4, left: "DHCP", right: "Tự động cấp phát IP cho thiết bị" }
    ],
    e: "TCP bắt tay 3 bước đảm bảo an toàn. UDP bắn dữ liệu liên tục ('Bắn và quên'). DNS giống như danh bạ điện thoại."
  },
  {
    subject: 'network',
    type: 'match',
    q: "Ghép thiết bị mạng với tầng OSI hoạt động:",
    pairs: [
      { id: 1, left: "Router (Bộ định tuyến)", right: "Tầng 3 (Network Layer) - Dùng IP" },
      { id: 2, left: "Switch (Bộ chuyển mạch)", right: "Tầng 2 (Data Link) - Dùng MAC" },
      { id: 3, left: "Hub", right: "Tầng 1 (Physical) - Chuyển tiếp tín hiệu điện" },
      { id: 4, left: "Firewall", right: "Tầng 4-7 (Bảo mật, lọc gói tin)" }
    ],
    e: "Router định tuyến đường đi (IP). Switch chuyển dữ liệu trong mạng LAN (MAC)."
  },
  ...
  // --- CHỦ ĐỀ: TRÍ TUỆ NHÂN TẠO (AI) ---
  {
    subject: 'ai',
    type: 'match',
    q: "Ghép khái niệm AI với ví dụ thực tế:",
    pairs: [
      { id: 1, left: "Machine Learning", right: "Youtube gợi ý video dựa trên lịch sử xem" },
      { id: 2, left: "AI Tạo sinh (Generative)", right: "ChatGPT viết thơ, Midjourney vẽ tranh" },
      { id: 3, left: "Thị giác máy tính", right: "FaceID mở khóa điện thoại" },
      { id: 4, left: "Xử lý ngôn ngữ (NLP)", right: "Google Dịch, Siri, Google Assistant" }
    ],
    e: "Generative AI tạo ra cái mới. Machine Learning học từ cái cũ để dự đoán."
  },
  {
    subject: 'ai',
    type: 'match',
    q: "Ghép các mốc lịch sử AI:",
    pairs: [
      { id: 1, left: "Năm 1950", right: "Alan Turing đề xuất 'Phép thử Turing'" },
      { id: 2, left: "Năm 1956", right: "Hội thảo Dartmouth (Khai sinh thuật ngữ AI)" },
      { id: 3, left: "Năm 1997", right: "Deep Blue đánh bại vua cờ vua Kasparov" },
      { id: 4, left: "Năm 2022", right: "ChatGPT ra mắt, bùng nổ AI tạo sinh" }
    ],
    e: "1956 là năm quan trọng nhất khi thuật ngữ 'Artificial Intelligence' chính thức ra đời."
  },

  // ========================================================================
  // 2. DẠNG MỚI: TƯ DUY SÂU (PREDICT OUTPUT) - KHÔNG CHO ĐÁP ÁN TRƯỚC
  // ========================================================================
  
  // --- TƯ DUY CODE (HTML/CSS/PYTHON) ---
  {
    subject: 'html',
    type: 'predict',
    q: "Điều gì xảy ra với chiều rộng thực tế (Total Width)?",
    codeSnippet: `/* CSS */
.box {
  width: 100px;
  padding: 20px;
  ...
  box-sizing: content-box; /* Mặc định */
    ...
    a: "150px",
    e: "Với content-box: Tổng = width (100) + padding trái/phải (20+20) + border trái/phải (5+5) = 150px. Nếu dùng border-box thì mới là 100px."
  },
  {
    subject: 'html',
    type: 'predict',
    q: "Phần tử con sẽ nằm ở đâu?",
    codeSnippet: `<div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
  <div class="item">A</div>
</div>`,
    a: "Chính giữa màn hình (Cả dọc và ngang)",
    e: "`justify-content: center` căn giữa ngang. `align-items: center` căn giữa dọc. Kết hợp lại là chính giữa khung hình."
  },
  {
    subject: 'python',
    type: 'predict',
    q: "Dự đoán kết quả (Output) của đoạn code sau:",
    codeSnippet: `# Python List Reference
a = [1, 2, 3]
b = a
b.append(4)
print(a)`,
    a: "[1, 2, 3, 4]",
    e: "Trong Python, gán `b = a` là tham chiếu cùng bộ nhớ. Thay đổi `b` sẽ làm thay đổi cả `a`. Muốn copy phải dùng `b = a.copy()`."
  },
  {
    subject: 'python',
    type: 'predict',
    q: "Kết quả của phép so sánh này?",
    codeSnippet: `x = "10"
y = 10
print(x == y)`,
    a: "False",
    e: "Chuỗi '10' (String) khác hoàn toàn với số 10 (Integer). Python không tự động ép kiểu khi so sánh bằng (==)."
  },

  // --- TƯ DUY HỆ THỐNG (MẠNG & AI) ---
  {
    subject: 'network',
    type: 'predict',
    q: "Tình huống: Bạn đang xem Livestream bóng đá thì mạng lag, hình ảnh bị vỡ nhòe rồi lại bình thường. Giao thức nào đang được sử dụng?",
    codeSnippet: "Scenario: Real-time Video Streaming (Livestreaming)",
    a: "UDP (User Datagram Protocol)",
    e: "UDP ưu tiên tốc độ, chấp nhận mất gói tin (vỡ hình) để duy trì thời gian thực. Nếu dùng TCP, video sẽ bị dừng lại (buffering) để tải lại gói tin bị mất, làm chậm trải nghiệm."
  },
  {
    subject: 'ai',
    type: 'predict',
    q: "Hệ thống AI này thuộc loại nào?",
    codeSnippet: "Input: Hàng nghìn ảnh chụp X-quang phổi.\nTask: Phân loại ảnh nào là 'Bình thường', ảnh nào 'Bị viêm phổi'.",
    a: "AI Phân biệt (Discriminative AI)",
    e: "Hệ thống này chỉ làm nhiệm vụ Phân loại (Classify) dựa trên dữ liệu có sẵn, không tạo ra dữ liệu mới (Generative)."
  },
  {
    subject: 'ai',
    type: 'predict',
    q: "Rủi ro nào đang xảy ra?",
    codeSnippet: "Situation: Một AI tuyển dụng luôn loại bỏ hồ sơ của ứng viên nữ cho vị trí kỹ thuật, vì dữ liệu cũ toàn là nam giới.",
    a: "Bias (Định kiến dữ liệu)",
    e: "AI học từ dữ liệu quá khứ (Garbage In, Garbage Out). Nếu dữ liệu cũ có định kiến, AI sẽ sao chép định kiến đó."
  },

  // ========================================================================
  // 3. GIỮ LẠI CÁC CÂU CŨ (TEXT / MC / TF)
  // ========================================================================
   { 
    subject: 'color', type: 'text',
    q: "Mã màu Hex #FF0000 là màu gì? (Tiếng Anh)", 
  ...
  
  {
    subject: 'color',
    type: 'match',
    q: "Ghép mã HEX với tên màu tương ứng (Nhóm RGB):",
    pairs: [
      { id: 1, left: "#FF0000", right: "Red (Đỏ)" },
      { id: 2, left: "#00FF00", right: "Lime (Xanh lá mạ)" },
      { id: 3, left: "#0000FF", right: "Blue (Xanh dương)" },
      { id: 4, left: "#000000", right: "Black (Đen)" }
    ],
    e: "Quy tắc RGB: 2 ký tự đầu là Đỏ (R), 2 giữa là Xanh lá (G), 2 cuối là Xanh dương (B). FF là sáng nhất, 00 là tối nhất."
  },

  // --- GHÉP MÀU PHỐI (CMY - Cyan Magenta Yellow) ---
  {
    subject: 'color',
    type: 'match',
    q: "Ghép mã HEX với kết quả phối màu:",
    pairs: [
      { id: 1, left: "#FFFF00 (Red + Green)", right: "Yellow (Vàng)" },
      { id: 2, left: "#00FFFF (Green + Blue)", right: "Cyan / Aqua (Xanh lơ)" },
      { id: 3, left: "#FF00FF (Red + Blue)", right: "Magenta / Fuchsia (Hồng cánh sen)" },
      { id: 4, left: "#FFFFFF (R + G + B)", right: "White (Trắng)" }
    ],
    e: "Đây là các màu thứ cấp (Secondary Colors) trong hệ ánh sáng. Trắng là sự kết hợp của tất cả các màu."
  },

  // --- GHÉP HỆ MÀU HSL (Hue - Saturation - Lightness) ---
  {
    subject: 'color',
    type: 'match',
    q: "Ghép các thành phần của HSL với ý nghĩa:",
    pairs: [
      { id: 1, left: "Hue (H)", right: "Vòng tròn màu (0-360 độ)" },
      { id: 2, left: "Saturation (S)", right: "Độ bão hòa (0% là xám, 100% là màu rực)" },
      { id: 3, left: "Lightness (L)", right: "Độ sáng (0% là đen, 100% là trắng)" },
      { id: 4, left: "Alpha (A)", right: "Độ trong suốt (0 là tàng hình)" }
    ],
    e: "HSL trực quan hơn HEX. Muốn chỉnh màu tối đi chỉ cần giảm Lightness. Muốn màu nhạt đi (về xám) thì giảm Saturation."
  },

  // --- GHÉP MÀU TỐI (DARK SHADES) ---
  {
    subject: 'color',
    type: 'match',
    q: "Ghép phiên bản tối (Darker) của các màu chuẩn:",
    pairs: [
      { id: 1, left: "Maroon (#800000)", right: "Phiên bản tối của Red" },
      { id: 2, left: "Green (#008000)", right: "Phiên bản tối của Lime" },
      { id: 3, left: "Navy (#000080)", right: "Phiên bản tối của Blue" },
      { id: 4, left: "Olive (#808000)", right: "Phiên bản tối của Yellow" }
    ],
    e: "Trong hệ HEX chuẩn, giá trị 80 (128) là một nửa độ sáng so với FF (255), tạo ra phiên bản tối hơn."
  },

  // ========================================================================
  // 2. DẠNG MỚI: TƯ DUY SÂU (PREDICT OUTPUT) - COLOR LOGIC
  // ========================================================================

  {
    ...
    type: 'predict',
    q: "Màu gì sẽ hiện ra?",
    codeSnippet: `/* CSS RGB Mixing */
.box {
  background-color: rgb(255, 0, 0); /* Red */
  opacity: 0.5; /* Trong suốt 50% */
  /* Đặt trên nền trắng */
}`,
    a: "Màu hồng nhạt (Pinkish)",
    e: "Màu đỏ (Red) khi bị làm trong suốt 50% trên nền trắng sẽ pha trộn với màu trắng tạo thành màu hồng."
  },
  {
    subject: 'color',
    type: 'predict',
    q: "Dự đoán mã màu HEX rút gọn:",
    codeSnippet: `.title {
  color: #F0F; /* Shorthand Hex */
}`,
    a: "#FF00FF (Magenta)",
    e: "Hệ HEX rút gọn nhân đôi từng ký tự: #F0F tương đương #FF00FF (Red=FF, Green=00, Blue=FF). Đây là màu Hồng cánh sen."
  },
  {
    subject: 'color',
    type: 'predict',
    q: "Giá trị Hue này ra màu gì?",
    codeSnippet: `/* HSL Color Wheel */
.circle {
  background: hsl(120, 100%, 50%);
}`,
    a: "Màu Xanh lá (Green)",
    e: "Vòng tròn màu: 0°/360° = Đỏ, 120° = Xanh lá, 240° = Xanh dương."
  },
  {
    subject: 'color',
    type: 'predict',
    q: "Màu này trông như thế nào?",
    codeSnippet: `body {
  background: hsl(0, 0%, 50%);
}`,
    a: "Màu Xám (Gray)",
    e: "Khi Saturation (Độ bão hòa) bằng 0%, màu sắc biến mất, chỉ còn lại sắc độ xám. Lightness 50% là xám trung tính."
  },

  // ========================================================================
  // 3. TRẮC NGHIỆM NHANH (16 MÀU CHUẨN + LÝ THUYẾT)
  // ========================================================================
  
  // --- NHÓM MÀU SÁNG (LIGHT) ---
  { 
    subject: 'color', type: 'text',
    q: "Mã #FF0000 là màu gì? (Tiếng Anh)", a: "Red", e: "R=Max, G=0, B=0.", colorCode: "#FF0000" 
  },
  { 
    subject: 'color', type: 'text',
    q: "Mã #00FF00 là màu gì? (Tiếng Anh - Lưu ý: Sáng nhất)", a: "Lime", e: "Lime là Green ở độ sáng tối đa (FF).", colorCode: "#00FF00" 
  },
  { 
    subject: 'color', type: 'text',
    q: "Mã #0000FF là màu gì? (Tiếng Anh)", a: "Blue", e: "Màu xanh dương chuẩn.", colorCode: "#0000FF" 
  },
  { 
    subject: 'color', type: 'text',
    q: "Mã #FFFF00 là màu gì? (Red + Green)", a: "Yellow", e: "Đỏ + Xanh lá = Vàng.", colorCode: "#FFFF00" 
  },
  { 
    subject: 'color', type: 'text',
    q: "Mã #00FFFF là màu gì? (Green + Blue)", a: "Aqua", e: "Tên khác là Cyan. Xanh ngọc sáng.", colorCode: "#00FFFF" 
  },
  { 
    subject: 'color', type: 'text',
    q: "Mã #FF00FF là màu gì? (Red + Blue)", a: "Fuchsia", e: "Tên khác là Magenta. Hồng cánh sen.", colorCode: "#FF00FF" 
  },

  // --- NHÓM MÀU TRUNG TÍNH (GRAYSCALE) ---
  { 
    subject: 'color', type: 'text',
    q: "Mã #FFFFFF là màu gì?", a: "White", e: "Tất cả các kênh màu đều Max -> Trắng.", colorCode: "#FFFFFF" 
  },
  { 
    subject: 'color', type: 'text',
    q: "Mã #000000 là màu gì?", a: "Black", e: "Tất cả các kênh màu đều Min -> Đen.", colorCode: "#000000" 
  },
  { 
    subject: 'color', type: 'mc',
    q: "Màu #808080 là màu gì?", a: "Gray", o: ["Silver", "Black", "White"], e: "Gray là xám trung tính (128/255).", colorCode: "#808080"
  },
  { 
    subject: 'color', type: 'mc',
    q: "Màu #C0C0C0 là màu gì?", a: "Silver", o: ["Gray", "White", "Platinum"], e: "Silver sáng hơn Gray (192/255).", colorCode: "#C0C0C0"
  },

  // --- NHÓM MÀU TỐI (DARK) ---
  { 
    subject: 'color', type: 'mc',
    q: "Mã #800000 là màu gì?", a: "Maroon", o: ["Red", "Brown", "Crimson"], e: "Đỏ sậm.", colorCode: "#800000"
  },
  { 
    subject: 'color', type: 'mc',
    q: "Mã #808000 là màu gì?", a: "Olive", o: ["Yellow", "Lime", "Green"], e: "Vàng tối ngả xanh (Màu quả oliu).", colorCode: "#808000"
  },
  { 
    subject: 'color', type: 'mc',
    q: "Mã #008000 là màu gì?", a: "Green", o: ["Lime", "Forest", "Teal"], e: "Lưu ý: Trong HTML, 'Green' là màu tối (#008000), còn màu sáng hẳn là 'Lime' (#00FF00).", colorCode: "#008000"
  },
  { 
    subject: 'color', type: 'mc',
    q: "Mã #800080 là màu gì?", a: "Purple", o: ["Fuchsia", "Violet", "Indigo"], e: "Tím sậm.", colorCode: "#800080"
  },
  { 
    subject: 'color', type: 'mc',
    q: "Mã #008080 là màu gì?", a: "Teal", o: ["Aqua", "Cyan", "Blue"], e: "Xanh cổ vịt (Xanh lam ngọc tối).", colorCode: "#008080"
  },
  { 
    subject: 'color', type: 'mc',
    q: "Mã #000080 là màu gì?", a: "Navy", o: ["Blue", "Royal", "Midnight"], e: "Xanh hải quân.", colorCode: "#000080"
  },
  ...
  // --- CÂU HỎI KHÁC VỀ MÀU ---
  {
    subject: 'color',
    type: 'tf',
    q: "ĐÚNG hay SAI: Hệ màu RGBA có thêm kênh Alpha để chỉnh độ trong suốt?",
    a: "Đúng",
    o: ["Sai"],
    e: "A = Alpha. Giá trị từ 0 (trong suốt) đến 1 (đậm đặc)."
  },
  {
    subject: 'color',
    type: 'text',
    q: "Trong mã HEX #123456, hai ký tự '34' đại diện cho màu nào? (Red/Green/Blue)",
    a: "Green",
    e: "Cấu trúc: RR GG BB. Vị trí giữa là Green."
  },
  
  // ========================================================================
  // CÁC CÂU CŨ (GIỮ LẠI ĐỂ ĐA DẠNG)
  // ========================================================================
  {
    subject: 'html',
    type: 'match',
    q: "Ghép thẻ HTML với chức năng:",
    pairs: [
      { id: 1, left: "<a>", right: "Tạo liên kết" },
      { id: 2, left: "<ul>", right: "Danh sách chấm tròn" },
      { id: 3, left: "<table>", right: "Tạo bảng" },
      { id: 4, left: "<input>", right: "Nhập liệu" }
    ],
    e: "Các thẻ cơ bản nhất của HTML."
  },
  {
    subject: 'network',
    type: 'predict',
    q: "Giao thức nào đang hoạt động?",
    codeSnippet: "Scenario: Livestream bóng đá, hình ảnh bị vỡ nhưng không dừng lại.",
    a: "UDP",
    e: "UDP chấp nhận mất gói tin để đảm bảo tốc độ thời gian thực."
  },
